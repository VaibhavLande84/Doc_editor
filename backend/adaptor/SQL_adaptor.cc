...
void SQL_adaptor::fetchDocumentsByUserId(
    int targetUserId,
...
void SQL_adaptor::fetchUserDetails(
    int targetUserId,
...
void SQL_adaptor::fetchSpecificDocument(
    int docId,
    int userId,
...
void SQL_adaptor::fetchUserCredentials(
    const std::string& username,
...
void SQL_adaptor::deleteDocument(
    int docId,
    int userId,
